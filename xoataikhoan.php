...
<body id="page-top">
    ...
    <?php include("menu.php");?>
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <form class="form-capquyen" method="POST" action="xulyxoatk.php">
            <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <button class="btn btn-primary" type="submit"id="xoataikhoan" name="xoataikhoan"style="width: 125px;">Xóa tài khoản</button>
            </div>
            </div>
            </form>
        </div>
