                ...
                <table class="table table-bordered table-hover">
                    <thead class="bill-header cs">
                        <tr>
                            ...
                            <th id="trs-hd" width="10%">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center"><a class="btn btn-success" role="button" style="margin-left: 5px;" href="#"><i class="fa fa-folder-open-o" style="font-size: 15px;"></i></a><a class="btn btn-success" role="button" style="margin-left: 5px;" href="#"><i class="fa fa-reply" style="font-size: 15px;"></i></a>
                                <button
                                    class="btn btn-danger" style="margin-left: 5px;" type="submit"><i class="fa fa-trash" style="font-size: 15px;" href="#"></i></button>
                            </td>
                        </tr>
                    </tbody>
                </table>
